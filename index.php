    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card text-center">
          ...
          <div class="card-body">
            <span class="btn btn-primary" data-toggle="modal" data-target="#agregarnuevosdatosmodal">Agregar nuevo<span class="fa fa-plus-circle"
              ></span>
            </span>
            <hr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="frmnuevo">
            <label>Nombre</label>
            <input type="" class="form-control input-sm" id="nombre" name="nombre">
            <label>Año</label>
            <input type="" class="form-control input-sm" id="anio" name="anio">
            <label>Empresa</label>
            <input type="" class="form-control input-sm" id="empresa" name="empresa">
          </form>
        </div>
